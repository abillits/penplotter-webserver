...
def update_preview():
    if request.method == "POST":
        ...
        subprocess.run('v4l2-ctl --device /dev/video0 --set-fmt-video=width=2560,height=1440,pixelformat=MJPG --stream-mmap --stream-to=/home/pi/webplotter/timelapse/preview.jpg --stream-count=1', shell=True)
